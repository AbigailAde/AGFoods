...
import { ChevronRight, QrCode, ArrowLeft, CheckCircle, AlertCircle } from 'lucide-react';
  ...
  const userTypes = [
    {
      ...
      fields: ['firstName', 'lastName', 'email', 'phone', 'password', 'confirmPassword', 'location']
    }
  ];
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        {currentStep === 'userType' && (
          <div className="text-center">
            <h1 className="text-3xl font-bold text-gray-900 mb-4">Join AGFoods as a Consumer</h1>

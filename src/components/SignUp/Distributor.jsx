  ...
  const userTypes = [
    {
      ...
      fields: ['firstName', 'lastName', 'email', 'phone', 'password', 'confirmPassword', 'companyName', 'location']
    }
  ];
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        {currentStep === 'userType' && (
          <div className="text-center">
            <h1 className="text-3xl font-bold text-gray-900 mb-4">Join AGFoods as a Distributor</h1>

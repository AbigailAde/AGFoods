...
} from "./chunk-BRVEQSQ7.js";
import "./chunk-H2F5QFBS.js";
import "./chunk-QT4K3USJ.js";
...
import {
  ...
  polygonAmoy,
  sepolia
} from "./chunk-CQPHIOUX.js";
import "./chunk-GI5CWWSB.js";
import {
  Field,
  FpInvertBatch,
  FpSqrtEven,
  ...
  validateBasic,
  wNAF
} from "./chunk-4H6QRKU4.js";
import {
  SHA256_IV,
  sha512
} from "./chunk-PJM2FLQM.js";
import "./chunk-IKBXVOS3.js";
import {
...
import {
  ...
  u8,
  utf8ToBytes
} from "./chunk-MZRZYOOG.js";
import {
  useQuery
} from "./chunk-E2FSN4FF.js";
import {
  require_jsx_runtime
} from "./chunk-UAINIZZH.js";
import {
  require_react_dom
} from "./chunk-BRKHHTZ3.js";
import {
  require_react
} from "./chunk-MNXMQUHG.js";
import {
  __commonJS,
  __toESM
...
var require_range = __commonJS({
  "node_modules/@metamask/utils/node_modules/semver/classes/range.js"(exports, module) {
    ...
    var hyphenReplace = (incPr) => ($0, from7, fM, fm, fp, fpr, fb, to, tM, tm, tp, tpr) => {
      if (isX(fM)) {
        from7 = "";
      } else if (isX(fm)) {
        from7 = `>=${fM}.0.0${incPr ? "-0" : ""}`;
      } else if (isX(fp)) {
        from7 = `>=${fM}.${fm}.0${incPr ? "-0" : ""}`;
      } else if (fpr) {
        from7 = `>=${from7}`;
      } else {
        from7 = `>=${from7}${incPr ? "-0" : ""}`;
  ...
  return createConnector((config) => ({
    ...
    async getProvider() {
      if (!walletProvider) {
        ...
        const { createBaseAccountSDK } = await import("./dist-6KI74ROO.js");
  ...
  return createConnector((config) => ({
    ...
    async getProvider() {
      if (!walletProvider) {
        ...
        const { createCoinbaseWalletSDK } = await import("./dist-SZM56JDG.js");
    ...
    async getProvider() {
      if (!walletProvider) {
        const CoinbaseWalletSDK = await (async () => {
          const { default: SDK } = await import("./dist-VH2RBAN2.js");
    ...
    async getProvider() {
      async function initProvider() {
        const MetaMaskSDK = await (async () => {
          const { default: SDK } = await import("./metamask-sdk-EYSR72XS.js");
          if (typeof SDK !== "function" && typeof SDK.default === "function")
            return SDK.default;
          return SDK;
        })();
  ...
  return createConnector((config) => ({
    ...
    async getProvider() {
      ...
      if (!isIframe)
        return;
      if (!provider_) {
        const { default: SDK } = await import("./esm-PUQOZR33.js");
        ...
        const SafeAppProvider = await (async () => {
          const Provider = await import("./dist-5P4RXKZE.js");
    ...
    async getProvider({ chainId } = {}) {
      async function initProvider() {
        ...
        if (!optionalChains.length)
          return;
        const { EthereumProvider } = await import("./index.es-H4MFT7KA.js");
...
var fetchTranslations = async (locale) => {
  switch (locale) {
    case "ar":
    case "ar-AR":
      return (await import("./ar_AR-CTNWGWSS-JID6J5IK.js")).default;
    case "de":
    case "de-DE":
      return (await import("./de_DE-P43L3PR7-UTTIWTRL.js")).default;
    case "en":
    case "en-US":
      return (await import("./en_US-KAK2ZBDO-HLP3IDCI.js")).default;
    case "es":
    case "es-419":
      return (await import("./es_419-JBX5FS3Q-BBKDFZVO.js")).default;
    case "fr":
    case "fr-FR":
      return (await import("./fr_FR-CM2EDAQC-HATTXGSC.js")).default;
    case "hi":
    case "hi-IN":
      return (await import("./hi_IN-GYVCUYRD-6LT7H4FY.js")).default;
    case "id":
    case "id-ID":
      return (await import("./id_ID-7ZWSMOOE-BSCTHOHH.js")).default;
    case "ja":
    case "ja-JP":
      return (await import("./ja_JP-CGMP6VLZ-52DFLJMF.js")).default;
    case "ko":
    case "ko-KR":
      return (await import("./ko_KR-YCZDTF7X-4CPE35UX.js")).default;
    case "ms":
    case "ms-MY":
      return (await import("./ms_MY-5LHAYMS7-TUCMDKEZ.js")).default;
    case "pt":
    case "pt-BR":
      return (await import("./pt_BR-3JTS4PSK-X4HYVSX5.js")).default;
    case "ru":
    case "ru-RU":
      return (await import("./ru_RU-6J6XERHI-ZWXVZ5IV.js")).default;
    case "th":
    case "th-TH":
      return (await import("./th_TH-STXOD4CR-ZXTOUDWH.js")).default;
    case "tr":
    case "tr-TR":
      return (await import("./tr_TR-P7QAUUZU-UWCKKIRY.js")).default;
    case "ua":
    case "uk-UA":
      return (await import("./uk_UA-JTTBGJGQ-2D7PADFC.js")).default;
    case "vi":
    case "vi-VN":
      return (await import("./vi_VN-5XUUAVWW-3OKOYJY4.js")).default;
    case "zh":
    case "zh-CN":
    case "zh-Hans":
      return (await import("./zh_CN-RGMLPFEP-YIEAM6Z5.js")).default;
    case "zh-HK":
      return (await import("./zh_HK-YM3T6EI5-JKVQJDJ5.js")).default;
    case "zh-Hant":
    case "zh-TW":
      return (await import("./zh_TW-HAEH6VE5-DFHO462R.js")).default;
    default:
      return (await import("./en_US-KAK2ZBDO-HLP3IDCI.js")).default;
  }
};

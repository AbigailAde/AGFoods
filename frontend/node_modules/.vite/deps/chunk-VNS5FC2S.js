...
var ICONS = {
  add: async () => (await import("./add-6M7TSYA6.js")).addSvg,
  allWallets: async () => (await import("./all-wallets-GMSLP5X6.js")).allWalletsSvg,
  arrowBottomCircle: async () => (await import("./arrow-bottom-circle-FBDY3JUD.js")).arrowBottomCircleSvg,
  appStore: async () => (await import("./app-store-U57LDGWN.js")).appStoreSvg,
  apple: async () => (await import("./apple-AZ5YMAI2.js")).appleSvg,
  arrowBottom: async () => (await import("./arrow-bottom-NJIEEQRC.js")).arrowBottomSvg,
  arrowLeft: async () => (await import("./arrow-left-QHYXFYZL.js")).arrowLeftSvg,
  arrowRight: async () => (await import("./arrow-right-ULG7XGHE.js")).arrowRightSvg,
  arrowTop: async () => (await import("./arrow-top-2THV2644.js")).arrowTopSvg,
  bank: async () => (await import("./bank-NHLZ7DU3.js")).bankSvg,
  browser: async () => (await import("./browser-OW6MXYXU.js")).browserSvg,
  card: async () => (await import("./card-BJ2FVIRP.js")).cardSvg,
  checkmark: async () => (await import("./checkmark-45XK5K7G.js")).checkmarkSvg,
  checkmarkBold: async () => (await import("./checkmark-bold-PANACRIG.js")).checkmarkBoldSvg,
  chevronBottom: async () => (await import("./chevron-bottom-I72QARDL.js")).chevronBottomSvg,
  chevronLeft: async () => (await import("./chevron-left-RESIEDX7.js")).chevronLeftSvg,
  chevronRight: async () => (await import("./chevron-right-DFGAQFIN.js")).chevronRightSvg,
  chevronTop: async () => (await import("./chevron-top-TBCNBWJU.js")).chevronTopSvg,
  chromeStore: async () => (await import("./chrome-store-FBENRQ72.js")).chromeStoreSvg,
  clock: async () => (await import("./clock-EFX6MNLY.js")).clockSvg,
  close: async () => (await import("./close-BSI46VS2.js")).closeSvg,
  compass: async () => (await import("./compass-4Z266NO6.js")).compassSvg,
  coinPlaceholder: async () => (await import("./coinPlaceholder-T7WPQE4P.js")).coinPlaceholderSvg,
  copy: async () => (await import("./copy-7WSQM2KM.js")).copySvg,
  cursor: async () => (await import("./cursor-ZBIZEL2G.js")).cursorSvg,
  cursorTransparent: async () => (await import("./cursor-transparent-34ADS5WF.js")).cursorTransparentSvg,
  desktop: async () => (await import("./desktop-PIW5QJBI.js")).desktopSvg,
  disconnect: async () => (await import("./disconnect-OMWC5D4C.js")).disconnectSvg,
  discord: async () => (await import("./discord-WNFV2M3M.js")).discordSvg,
  etherscan: async () => (await import("./etherscan-ZNNOG7IR.js")).etherscanSvg,
  extension: async () => (await import("./extension-LNHO7PTH.js")).extensionSvg,
  externalLink: async () => (await import("./external-link-RBYXMWQI.js")).externalLinkSvg,
  facebook: async () => (await import("./facebook-WYVBFEVE.js")).facebookSvg,
  farcaster: async () => (await import("./farcaster-CUTDSJL2.js")).farcasterSvg,
  filters: async () => (await import("./filters-EPFRRL7M.js")).filtersSvg,
  github: async () => (await import("./github-5J5BLJGW.js")).githubSvg,
  google: async () => (await import("./google-NG2OQ3QW.js")).googleSvg,
  helpCircle: async () => (await import("./help-circle-N4HYJWVG.js")).helpCircleSvg,
  image: async () => (await import("./image-YL6G5RHJ.js")).imageSvg,
  id: async () => (await import("./id-ZTCUWT3C.js")).idSvg,
  infoCircle: async () => (await import("./info-circle-TRKGXSK3.js")).infoCircleSvg,
  lightbulb: async () => (await import("./lightbulb-GCCUAW5S.js")).lightbulbSvg,
  mail: async () => (await import("./mail-A63JXK6H.js")).mailSvg,
  mobile: async () => (await import("./mobile-AGHTKGST.js")).mobileSvg,
  more: async () => (await import("./more-CVOBSA4D.js")).moreSvg,
  networkPlaceholder: async () => (await import("./network-placeholder-KUXZVGKK.js")).networkPlaceholderSvg,
  nftPlaceholder: async () => (await import("./nftPlaceholder-CTKOVHDU.js")).nftPlaceholderSvg,
  off: async () => (await import("./off-4BOU4KU3.js")).offSvg,
  playStore: async () => (await import("./play-store-KO4DAEXI.js")).playStoreSvg,
  plus: async () => (await import("./plus-OAHJWL56.js")).plusSvg,
  qrCode: async () => (await import("./qr-code-6BB3NS5M.js")).qrCodeIcon,
  recycleHorizontal: async () => (await import("./recycle-horizontal-AYI34NRG.js")).recycleHorizontalSvg,
  refresh: async () => (await import("./refresh-INE3JNN7.js")).refreshSvg,
  search: async () => (await import("./search-55235CMX.js")).searchSvg,
  send: async () => (await import("./send-BIEEHSE6.js")).sendSvg,
  swapHorizontal: async () => (await import("./swapHorizontal-2AESSLNB.js")).swapHorizontalSvg,
  swapHorizontalMedium: async () => (await import("./swapHorizontalMedium-XHXXMTBH.js")).swapHorizontalMediumSvg,
  swapHorizontalBold: async () => (await import("./swapHorizontalBold-FPLQRT2A.js")).swapHorizontalBoldSvg,
  swapHorizontalRoundedBold: async () => (await import("./swapHorizontalRoundedBold-WOA3TVXF.js")).swapHorizontalRoundedBoldSvg,
  swapVertical: async () => (await import("./swapVertical-TYMPTB2G.js")).swapVerticalSvg,
  telegram: async () => (await import("./telegram-Y62GLNWI.js")).telegramSvg,
  threeDots: async () => (await import("./three-dots-IY7ORIO6.js")).threeDotsSvg,
  twitch: async () => (await import("./twitch-HEXE3FV6.js")).twitchSvg,
  twitter: async () => (await import("./x-TP22FVCP.js")).xSvg,
  twitterIcon: async () => (await import("./twitterIcon-GZZEE6LE.js")).twitterIconSvg,
  verify: async () => (await import("./verify-QKAFK6FW.js")).verifySvg,
  verifyFilled: async () => (await import("./verify-filled-TNZSKT6T.js")).verifyFilledSvg,
  wallet: async () => (await import("./wallet-DTAHZSAG.js")).walletSvg,
  walletConnect: async () => (await import("./walletconnect-JHCXP7Z3.js")).walletConnectSvg,
  walletConnectLightBrown: async () => (await import("./walletconnect-JHCXP7Z3.js")).walletConnectLightBrownSvg,
  walletConnectBrown: async () => (await import("./walletconnect-JHCXP7Z3.js")).walletConnectBrownSvg,
  walletPlaceholder: async () => (await import("./wallet-placeholder-2DWTFSLD.js")).walletPlaceholderSvg,
  warningCircle: async () => (await import("./warning-circle-CIY2FVZP.js")).warningCircleSvg,
  x: async () => (await import("./x-TP22FVCP.js")).xSvg,
  info: async () => (await import("./info-FIKWAHRI.js")).infoSvg,
  exclamationTriangle: async () => (await import("./exclamation-triangle-GTM7MA57.js")).exclamationTriangleSvg,
  reown: async () => (await import("./reown-logo-YDSZXFHG.js")).reownSvg
};
...
//# sourceMappingURL=chunk-VNS5FC2S.js.map
